        ...
        <section className="max-w-5xl mx-auto flex flex-col-reverse md:grid md:grid-cols-3 gap-8 items-center">
            <div className="md:col-span-2 space-y-4">
                <div className="flex flex-col items-center md:grid gap-1">
                    <h2 className="font-bold text-2xl md:text-4xl text-orange-400">
                        Phillip Cantu
                    </h2>
                    <p className="text-sm md:text-lg text-slate-400">
                        Full Stack Developer | Full Sail University
                    </p>
                    <p className="space-x-2 text-sm md:text-lg text-blue-400 md:indent-2">
                ...
                <p className="md:text-lg">
                    ...
                    Academy&#39;s Fullstack + AI bootcamp, and I&#39;m currently
                    attending Full Sail University with an expected graduation
                    in February 2027. I&#39;m from Arizona and I&#39;m a U.S.
                    Army veteran.
                </p>
            </div>
            <div className="max-w-60 md:max-w-80 border-8 border-slate-200 rounded-full md:opacity-60 transition duration-300 hover:opacity-100 grid">
                <Image
